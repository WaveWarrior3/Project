function [Lz,Rz,time,Lpos,Rpos] = lookahead(xdat,ydat,zdat,omegaL,omegaR,alphaL,alphaR,gps_data,imu_data)
...
%initial values
theta = imu_data(3); %forward, as it were
x = gps_data(3)-(2.22-0.76)*cos(theta);
y = gps_data(1)-(2.22-0.76)*sin(theta);
